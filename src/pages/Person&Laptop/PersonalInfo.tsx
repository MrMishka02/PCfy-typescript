...
const schema = yup.object().shape({
  ...
  phoneNumber: yup
    ...
    .matches(
      /^(\+995)(79\d{7}|5\d{8})$/,
      'უნდა აკმაყოფილებდეს ქართული მობილურის ნომრის ფორმატს (+995 *** ** ** **)'
    ),
})
    ...
    <div className='m-0'>
      ...
      <div className='mt-[5.7rem] flex justify-center sm:mt-[1.9rem]'>
        ...
        <div className='sm:hidden'>
          <HeadLabel text={'ლეპტოპის მახასიათებლები'} showLine={false} />
        </div>
      </div>
      <form
      ...
      >
        ...
        <div className='w-[71.8%] flex justify-end mt-[9.3rem] mx-auto lg:justify-center'>
          <div className='h-[3.75rem] w-[11rem]'>
            <NextButton
              text={'შემდეგი'}
              type='submit'
              isValid={isValid}
