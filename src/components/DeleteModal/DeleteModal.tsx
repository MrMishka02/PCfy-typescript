...
const DeleteModal = ({
  ...
  return (
    ...
    >
      <div className='flex h-[33.56rem] w-[52.9rem] flex-col sm:h-[22rem] lg:w-[90%] sm:overflow-y-scroll'>
        <div className='flex flex-col items-center justify-center rounded-lg bg-white p-2'>
          <img src={redcross} alt='Delete' className='w-[12rem] sm:w-[8rem]' />
          <p className='text-2xl font-[700] text-[#292929] lg:w-[90%] lg:text-center sm:text-base'>
            დარწმუნებული ხართ რომ გსურთ ჩანაწერის წაშლა?
          </p>
          <div className='flex gap-10 mt-20 mb-10 h-[3.75rem] w-[18.5625rem] text-[1.25rem] leading-6 sm:mt-[3rem] sm:mb-10 sm:w-[18.375rem]'>
            <Button
              text={'დიახ'}
              path='/entries-list'
              clickFunc={() => {
